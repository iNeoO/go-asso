...
func CreateOrganization(service *organization.Service) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		createdOrganization, err := service.Create(newOrganization)
		if err != nil {
			return c.Status(fiber.StatusInternalServerError).JSON(OrganizationErrorResponse("failed to create organization"))
		}

		if _, err := service.Join(createdOrganization.ID, userId, organization.RoleCreator); err != nil {
...
func JoinOrganization(service *organization.Service) fiber.Handler {
	return func(c *fiber.Ctx) error {
		id, err := uuid.Parse(c.Params("id"))
		if err != nil {
			return c.Status(fiber.StatusBadRequest).JSON(OrganizationErrorResponse("invalid organization id"))
...
func LeaveOrganization(service *organization.Service) fiber.Handler {
	return func(c *fiber.Ctx) error {
		id, err := uuid.Parse(c.Params("id"))
		if err != nil {
			return c.Status(fiber.StatusBadRequest).JSON(OrganizationErrorResponse("invalid organization id"))
...
// @Failure 404 {object} ErrorEnvelope
// @Failure 500 {object} ErrorEnvelope
func UpdateOrganizationUserRole(service *organization.Service) fiber.Handler {
	return func(c *fiber.Ctx) error {
		id, err := uuid.Parse(c.Params("id"))
		if err != nil {
			return c.Status(fiber.StatusBadRequest).JSON(OrganizationErrorResponse("invalid organization id"))
...
// @Failure 404 {object} ErrorEnvelope
// @Failure 500 {object} ErrorEnvelope
func ListOrganizationUsers(service *organization.Service) fiber.Handler {
	return func(c *fiber.Ctx) error {
		id, err := uuid.Parse(c.Params("id"))
		if err != nil {
			return c.Status(fiber.StatusBadRequest).JSON(OrganizationErrorResponse("invalid organization id"))
